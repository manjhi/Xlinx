package omninos.com.xlinx.CurvedBottomNavigation;
...
public class CurvedBottomNavigation extends BottomNavigationView {
    ...
    public final int CURVE_CIRCLE_RADIUS = 65;

    //the coordinate of first curve
    ...
    //the coordinate of second curev
...
//
//
//        //the coordinate(x,y) of the stsrt point befor curve
//        mFirstCurveStartPoint.set((mNavigationBarWidth / 2) - (CURVED_CIRCLE_RADIUS * 2) - (CURVED_CIRCLE_RADIUS / 3), 0);
//
//        //after curve
//        mFirstCurvedEndPoint.set((mNavigationBarWidth / 2), CURVED_CIRCLE_RADIUS + (CURVED_CIRCLE_RADIUS / 4));
//
//        mSecondCurveStartPoint = mFirstCurvedEndPoint;
//        mSecondCurvedEndPoint.set((mNavigationBarWidth / 2) + (CURVED_CIRCLE_RADIUS * 2) + (CURVED_CIRCLE_RADIUS / 3), 0);
//        mFirstCurvedControlPoint1.set(mFirstCurveStartPoint.x +(CURVED_CIRCLE_RADIUS)+(CURVED_CIRCLE_RADIUS/4),mFirstCurveStartPoint.y);
//
//        mFirstCurvedControlPoint2.set(mFirstCurvedEndPoint.x - (CURVED_CIRCLE_RADIUS * 2) + CURVED_CIRCLE_RADIUS, mFirstCurvedEndPoint.y);
//
//
//        mSecondCurvedControlPoint1.set(mSecondCurveStartPoint.x + (CURVED_CIRCLE_RADIUS * 2) - CURVED_CIRCLE_RADIUS, mSecondCurveStartPoint.y);
//
